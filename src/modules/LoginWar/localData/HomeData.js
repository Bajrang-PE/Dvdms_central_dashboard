...
export const DataSeries = [
    {
        Categories: [
            'Andhra Pradesh', 'Assam', 'Chhattisgarh', 'Haryana',
            'Jammu And Kashmir', 'Karnataka', 'Madhya Pradesh',
            'Manipur', 'Mizoram', 'Punjab', 'Telangana', 'Puducherry', 'Rajasthan', 'Uttarakhand', 'West Bengal'
        ],
        Data: [
            { name: 'Warehouses', data: [30, 50, 20, 10, 15, 60, 40, 25, 15, 35, 20, 80, 5, 34, 65], colorByPoint: true }
        ],
        title: "Warehouses Onboarded",
        xAxisTitle: "State/UT",
        yAxisTitle: "Warehouses"
    },
    {
        Categories: [
            'Andhra Pradesh', 'Assam', 'Chhattisgarh', 'Haryana',
            'Jammu And Kashmir', 'Karnataka', 'Madhya Pradesh',
            'Manipur', 'Mizoram', 'Puducherry', 'Rajasthan', 'Uttarakhand', 'West Bengal'
        ],
        Data: [
            { name: 'District Hospitals', data: [100, 150, 60, 50, 30, 200, 70, 40, 25, 60, 50, 220, 180], colorByPoint: true }
        ],
        title: "District Hospitals Onboarded",
        xAxisTitle: "State/UT",
        yAxisTitle: "District Hospitals"
    },
    {
        Categories: [
            'Andhra Pradesh', 'Assam', 'Chhattisgarh', 'Himachal Pradesh',
            'Jharkhand', 'Madhya Pradesh', 'Manipur', 'Punjab',
            'Telangana', 'Uttar Pradesh'
        ],
        Data: [
            { name: 'Medical Colleges', data: [40, 60, 50, 10, 5, 45, 50, 5, 70, 55], colorByPoint: true }
        ],
        title: "Medical Colleges Onboarded",
        xAxisTitle: "State/UT",
        yAxisTitle: "Medical Colleges"
    },
    {
        Categories: [
            'Andhra Pradesh', 'Assam', 'Chhattisgarh', 'Himachal Pradesh',
        ...
        Data: [
            { name: 'Sub Centres', data: [4, 60, 50, 18, 5, 45, 57, 5, 7, 35], colorByPoint: true }
        ],
        title: "Sub Centres Onboarded",
        xAxisTitle: "State/UT",
        yAxisTitle: "Sub Centres"
    },
    {
        Categories: [
            'Andhra Pradesh', 'Assam', 'Chhattisgarh', 'Himachal Pradesh',
        ...
        Data: [
            { name: 'Urban Community Health Centres', data: [4, 50, 18, 5, 45, 57, 5, 35], colorByPoint: true }
        ],
        title: "Urban Community Health Centres Onboarded",
        xAxisTitle: "State/UT",
        yAxisTitle: "Urban Community Health Centres"
    },
    {
        Categories: [
            'Andhra Pradesh', 'Assam', 'Chhattisgarh', 'Himachal Pradesh',
            'Jharkhand', 'Madhya Pradesh', 'Manipur', 'Punjab', 'Telangana'
        ],
        Data: [
            { name: 'Primary Health Centres', data: [4, 50, 8, 5, 45, 7, 5, 35, 23], colorByPoint: true }
        ],
        title: "Primary Health Centres Onboarded",
        xAxisTitle: "State/UT",
        yAxisTitle: "Primary Health Centres"
    },
    {
        Categories: [
            'Andhra Pradesh', 'Assam', 'Chhattisgarh', 'Haryana',
        ...
        Data: [
            { name: 'Community Health Centres', data: [10, 15, 60, 50, 30, 20, 70, 40, 25, 60, 50, 22, 18], colorByPoint: true }
        ],
        title: "Community Health Centres Onboarded",
        xAxisTitle: "State/UT",
        yAxisTitle: "Community Health Centres"
    },
    {
        Categories: [
            'Andhra Pradesh', 'Assam', 'Chhattisgarh', 'Haryana',
        ...
        Data: [
            { name: 'Urban Primary Health Centres', data: [100, 15, 6, 50, 30, 20, 7, 40, 25, 6, 50, 22, 18], colorByPoint: true }
        ],
        title: "Urban Primary Health Centres Onboarded",
        xAxisTitle: "State/UT",
        yAxisTitle: "Urban Primary Health Centres"
    },
    {
        Categories: [
            'Andhra Pradesh', 'Assam', 'Chhattisgarh', 'Haryana',
        ...
        Data: [
            { name: 'Sub District Hospitals', data: [10, 15, 61, 50, 30, 20, 27, 40, 25, 16, 50, 24, 8], colorByPoint: true }
        ],
        title: "Sub District Hospitals Onboarded",
        xAxisTitle: "State/UT",
        yAxisTitle: "Sub District Hospitals"
    },
    {
        Categories: [
            'Andhra Pradesh', 'Assam', 'Chhattisgarh', 'Haryana',
        ...
        Data: [
            { name: 'Health And Wellness Centres', data: [10, 155, 61, 50, 35, 20, 26, 40, 45, 16, 50, 54, 58], colorByPoint: true }
        ],
        title: "Health And Wellness Centres Onboarded",
        xAxisTitle: "State/UT",
        yAxisTitle: "Health And Wellness Centres"
    },
]
