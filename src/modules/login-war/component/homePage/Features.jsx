...
const Features = () => {
    ...
    return (
        <div className="features-section-container w-100 my-3" id="features" style={{ padding: "0 15px" }}>
            <style dangerouslySetInnerHTML={{
                ...
                /* Left Block (Visual Asset + Dynamic Color Description Frame) */
                ...
                .spotlight-image-frame {
                    width: 100%;
                    height: 170px;
                    /* सफ़ेद हर्ट करके थीम का कलर दिया गया है */
                    background: var(--primary-color, transparent);
                    display: flex;
                    align-items: center;
                    justify-content: center;
                ...
                /* Dynamic Background Theme Container */
                .spotlight-red-desc {
                    background: var(--primary-color, transparent); 
                    color: #ffffff;
                    padding: 12px 14px;
                    ...
                    <div className="spotlight-box-wrapper">
                        ...
                        <div className="spotlight-left-subframe">
                            ...
                            <div className="spotlight-red-desc">
                                ...
                                <div className="spotlight-second-image-wrap mt-2 text-center">
                                    <img
...
//                     </div>
//                 </div> {/* <--- Fix: Left Panel yahan properly close ho gaya hai */}
