  ...
  return (
    <>
      <Modal show={true} onHide={onClose} size="lg">
        ...
        <b>
          <h4 className="datatable-header mx-3 py-1 mt-1 px-1">
            Feedback Form
          </h4>
        </b>
        <Modal.Body className="px-3 py-0">
          <div className="card m-2">
            ...
            >
              ...
              <div
                className="w-100 py-1 my-2 opacity-75 rounded-3"
                style={{ backgroundColor: "#000e4e" }}
              ></div>
              ...
              <div className="text-center">
                ...
                <button
                  className="btn btn-sm new-btn-blue py-0"
                  onClick={() => {
                    setFeedback("");
                  }}
                >
