    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          parameters: [
            "./src/modules/his-utils/components/sidebar/Parameters.jsx",
          ],
          WidgetDash: [
            "./src/modules/his-utils/components/sidebar/WidgetDash.jsx",
          ],
          GraphDash: [
            "./src/modules/his-utils/components/sidebar/GraphDash.jsx",
          ],
          TabularDash: [
            "./src/modules/his-utils/components/sidebar/TabularDash.jsx",
          ],
